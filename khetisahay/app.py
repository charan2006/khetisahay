...
with open("/Users/charan/Desktop/khetisahay/templates/crops.json") as f:
    CROP_GUIDES = json.load(f)

def get_recent_crop_trends():
    with open("/Users/charan/Desktop/khetisahay/templates/mandi_market_dataset_300.json") as f:
        return json.load(f)
